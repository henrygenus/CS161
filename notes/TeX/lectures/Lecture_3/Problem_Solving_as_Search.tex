...
\begin{center} \begin{tikzpicture}
	\node[rectangle, draw] (1) {\begin{tabular} { c | c | c } 
		5 & 4 & . \\ \hline \\ 6 & 1 & 8 \\ \hline \\7 & 3 & 2 \end{tabular}};
	\node[rectangle, draw, right =of 1] (2) {\begin{tabular} { c | c | c } 
		5 & . & 4 \\ \hline \\ 6 & 1 & 8 \\ \hline \\7 & 3 & 2 \end{tabular}};
	\node [right =of 2] (3) {...};
	\node[rectangle, draw, right =of 3] (4) {\begin{tabular} { c | c | c } 
		1 & 2 & 3 \\ \hline \\ 8 & . & 4 \\ \hline \\7 & 5 & 6 \end{tabular}};
	\draw [->] (1.east) -- (2.west);
	\draw [->] (2.east) -- (3.west);
	\draw [->] (3.east) -- (4.west);
\end{tikzpicture} \end{center}
...
\begin{center} \begin{tikzpicture}
	\node [rectangle, draw]{\begin{tabular} { c | c } . & 1 \\ \hline \\ 3 & 2 \end{tabular}}
		child {node [rectangle, draw] {\begin{tabular} { c | c } 1 & . \\ \hline \\ 2 & 3 \end{tabular}}
			child {node [rectangle, draw]{\begin{tabular} { c | c } 1 & 2 \\ \hline \\ 3 & . \end{tabular}}
				child {node [rectangle, draw]{\begin{tabular} { c | c } 1 & 2 \\ \hline \\ . & 3 \end{tabular}}
					edge from parent node {}
				}
				child {node [ellipse, draw] {}
					edge from parent node{}
				}
				edge from parent node {}
			}
		...
		child [missing]
		child {node[rectangle, draw] {\begin{tabular} { c | c } 3 & 1 \\ \hline \\ . & 2 \end{tabular}}
			child {node [rectangle, draw]{\begin{tabular} { c | c } 3 & 1 \\ \hline \\ 2 & . \end{tabular}}
				child {node [rectangle, draw]{\begin{tabular} { c | c } 3 & 2 \\ \hline \\ 1 & . \end{tabular}}
					edge from parent node {}
				}
				child {node [ellipse, draw] {}
					edge from parent node{}
