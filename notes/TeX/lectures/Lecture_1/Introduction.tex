...
\begin{center}\begin{tikzpicture}
	\draw (0, 0) -- ++(0, 10) -- ++(3, 0) -- ++(0, -10) -- cycle;
	\node [align=center] at (1.5, 5) {Embedded\\Environments};
	\draw (5, 0) -- ++(0, 10) -- ++(8, 0) -- ++(0, -10) -- cycle;
	\draw (6, 1) -- ++(0, 3) -- ++(2, 0) -- ++(0, -3) -- cycle;
	\draw (6, 6) -- ++(0, 3) -- ++(2, 0) -- ++(0, -3) -- cycle;
	\node [align=center] at (7, 2.5) {\textbf{\underline{Action}}\\Writing\\Speech\\Display\\...};
	\node [align=center] at (7, 7.5) {\textbf{\underline{Perception}}\\Writing\\Speech\\Vision\\Touch\\Clicks\\...};
	\draw (10, 1) -- ++(0, 2) -- ++(2, 0) -- ++(0, -2) -- cycle;
	\draw (10, 4) -- ++(0, 2) -- ++(2, 0) -- ++(0, -2) -- cycle;
	\draw (10, 7) -- ++(0, 2) -- ++(2, 0) -- ++(0, -2) -- cycle;
	\node [align=center] at (11, 2) {Reasoning};
	\node [align=center] at (11, 5) {Knowledge};
	\node [align=center] at (11, 8) {Learning};
	\draw [<-] (3, 2.5) -- (6, 2.5);
	\draw [->] (3, 7.5) -- (6, 7.5);
	\draw [->] (8, 8) -- (10, 8);
	\draw (9, 8) -- (9, 2.5);
